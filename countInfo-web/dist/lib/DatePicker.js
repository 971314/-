...
strStyle += ".calendar ul {list-style-type: none;margin: 0;padding: 0;vertical-align: middle;}";
strStyle += "#PrevYear{width:34px; height:14px; font-size:14px; line-height:14px; display:block; float:left; position:absolute; background-image: url(/assets/bestpay/inside-main/topbaraggim01.png);left:10px; top:5px; cursor:pointer; background-repeat:no-repeat;background-position:center; }";
strStyle += "#NextYear{width:34px; height:14px; font-size:14px; line-height14px; display:block; float:right; position:absolute; right:10px; top:5px; cursor:pointer;background-position:center;background-image: url(/assets/bestpay/inside-main/topbaraggim02.png);background-repeat:no-repeat;	 }";
