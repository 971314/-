...
public class JsonUtil {
	...
	public static List<HashMap<String, Object>> getValueAsList(JsonNode jn) {
		try {
			...
			throw new DzException("JsonNode to List<Map> Error");
		}
	}
	...
	public static JsonNode str2jn(String json) {
		try {
			...
			throw new DzException("String to JsonNode Error");
		}
	}
	...
	public static Object str2obj(String json, Class cls) {
		try {
			...
			throw new DzException("String to Object Error");
		}
	}
	...
	public static String obj2json(Object obj) {
		...
		try {
			...
			throw new DzException("Object to Json Error");
		}
		return json;
	}
