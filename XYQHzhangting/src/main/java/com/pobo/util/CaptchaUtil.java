...
public class CaptchaUtil {
	...
	public static boolean check(String token, String captcha) {
		...
		String expectCaptcha = (String) SessionCacheManager.getInstance().get(token, CacheKey.CAPTCHA_PC);

		return captcha.toLowerCase().equals(expectCaptcha.toLowerCase());
	}
}
